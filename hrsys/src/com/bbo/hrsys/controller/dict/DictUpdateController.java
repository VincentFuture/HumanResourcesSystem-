...
/**
 * Servlet implementation class DictUpdateController
 */
@WebServlet("/updateDict")
public class DictUpdateController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DictUpdateController() {
        super();
    }
